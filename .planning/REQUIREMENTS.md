...
- [ ] **DASH-02**: User can filter dashboard and detail views by date range and activity attributes using one shared filter model
- [ ] **DASH-03**: User filter selections persist across navigation/reload
