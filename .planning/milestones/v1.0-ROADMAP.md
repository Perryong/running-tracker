...
- [x] 03-02-PLAN.md — Wire dashboard-to-detail query-preserving navigation and deterministic back/fallback behavior with navigation regression tests
...
- [x] 04-04-PLAN.md — Close verifier gap by wiring dashboard trend rendering to `summary.heart_rate.trend` contract semantics with regression tests
