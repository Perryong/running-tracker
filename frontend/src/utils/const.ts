...
// English location info messages are now supported
const ENGLISH_LOCATION_INFO_MESSAGE_FIRST =
  "I've run to some places, hoping that more places will be lit up as time goes on";
const ENGLISH_LOCATION_INFO_MESSAGE_SECOND =
  "Don't stop, keep running without stopping";
